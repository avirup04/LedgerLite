...
export default function Register() {
  ...
  // Debug: Verify environment variable binding
  ...
  return (
    <div className="flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white shadow-sm dark:bg-slate-900/50 dark:border-slate-800 dark:shadow-none p-8 backdrop-blur">
        ...
        <h1 className="mb-2 text-2xl font-bold text-slate-900 dark:text-white">Create your account</h1>
        <p className="mb-6 text-slate-500 dark:text-slate-400">Start tracking your finances today</p>
